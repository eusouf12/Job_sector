...
const Job = ({job}) => {
    const {id,logo,location,job_title,salary,company_name,remote_or_onsite,job_type}=job;
    return (
        ...
        <div className="card-body">
            ...
            <div className="flex gap-5">
                <button className="btn font-extrabold border-[#7E90FE] text-blue-700">{remote_or_onsite}</button>
                <button className="btn font-extrabold border-[#7E90FE] text-blue-700">{job_type}</button>
            </div>
            ...
            <div className="pt-2 ">
                ...
                <p className="flex gap-1"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <span className="pr-5">{location}</span>
