...
const JobDetails = () => {
    ...
    const handleApplyJob =()=>{
        ...
        saveJobApply(idInt);
        toast('You are succesfully apply');
    }

    return (
        <div>
            <h2 className="text-center text-3xl font-extrabold">Job Details</h2>
            <div className="grid lg:grid-cols-4 py-10 gap-4">
                <div className=" lg:col-span-3 space-y-5">
                    <h2><span className="font-extrabold">Job Description:</span> A UI/UX (User Interface/User Experience) designer is responsible for designing and creating engaging and effective interfaces for software and web applications. This includes designing the layout, visual design, and interactivity of the user interface.</h2>
                    <h2><span className="font-extrabold">Job Responsibility :</span> Collaborating with cross-functional teams: UI/UX designers often work closely with other teams, including product management, engineering, and marketing, to ensure that the user interface is aligned  with business and technical requirements. You will need to be able to effectively communicate your design ideas and gather feedback from other team members.</h2>
                ...
                <div className=" space-y-5 lg:col-span-1 bg-blue-50 p-5 rounded-2xl">
                    ...
                    <p className=" font-medium flex gap-1">
                        ...
                        <span className="font-extrabold">Salary :</span> 100K - 150K (Per Month)</p>
                    <p className=" font-medium flex gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span className="font-extrabold">Job Title :</span> Product Designer
                    </p>
                    ...
                    <p className=" font-medium flex gap-1">
                        ...
                        <span className="font-extrabold">Phone :</span>  01750-00 00 00
                    </p>
                    <p className=" font-medium flex gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span className="font-extrabold">Email :</span> info@gmail.com
                    </p>
                    ...
                    <p className=" font-medium flex gap-1">
                        ...
                        <span className="font-extrabold">Address:</span> Dhanmondi 32, Sukrabad Dhaka, Bangladesh
                    </p>
                    <button onClick={handleApplyJob}
                     className="btn w-full bg-blue-400">Apply Now</button>
                </div>
            </div>
            <ToastContainer />
        </div>
